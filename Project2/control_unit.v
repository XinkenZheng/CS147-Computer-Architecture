...
reg [`DATA_INDEX_LIMIT:0] RF_DATA_W_RET;
reg [`REG_ADDR_INDEX_LIMIT:0] RF_ADDR_W_RET, RF_ADDR_R1_RET, RF_ADDR_R2_RET;
reg RF_READ_RET, RF_WRITE_RET;
reg [`DATA_INDEX_LIMIT:0] ALU_OP1_RET, ALU_OP2_RET;
reg [`ALU_OPRN_INDEX_LIMIT:0] ALU_OPRN_RET;
reg [`ADDRESS_INDEX_LIMIT:0] MEM_ADDR_RET;
reg MEM_READ_RET, MEM_WRITE_RET;
reg[`DATA_INDEX_LIMIT:0] MEM_DATA_RET; 

assign RF_DATA_W = RF_DATA_W_RET;
assign RF_ADDR_W = RF_ADDR_W_RET;
assign RF_ADDR_R1 = RF_ADDR_R1_RET;
assign RF_ADDR_R2 = RF_ADDR_R2_RET;
assign RF_READ = RF_READ_RET;
assign RF_WRITE = RF_WRITE_RET;
assign ALU_OP1 = ALU_OP1_RET;
assign ALU_OP2 = ALU_OP2_RET;
assign ALU_OPRN = ALU_OPRN_RET;
assign MEM_ADDR = MEM_ADDR_RET;
assign MEM_READ = MEM_READ_RET;
assign MEM_WRITE = MEM_WRITE_RET;
